...
must_haves:
  truths:
    - "Slack event payloads are validated before processing"
    - "User input is sanitized before reaching AI prompts"
    - "Prompt injection patterns are detected and handled"
