...
must_haves:
  truths:
    - "System finds similar messages from user's communication history"
    - "System stores user message patterns for future retrieval"
    - "System identifies writing style characteristics (greetings, signoffs, punctuation)"
