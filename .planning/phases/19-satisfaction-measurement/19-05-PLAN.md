...
Import types from satisfaction-analytics.
...
All components should handle empty/null data gracefully with placeholder messages.
  ...
  <done>6 chart components created with proper empty state handling, consistent Tremor styling, and data visualization.</done>
</task>
