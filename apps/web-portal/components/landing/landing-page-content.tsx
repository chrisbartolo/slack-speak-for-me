  ...
  return (
    <>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Craft Perfect Slack Responses with <span className="text-[#4A154B]">AI</span>
            </h1>
            ...
            <div className="mt-10 flex items-center gap-x-6">
              <a href={slackInstallUrl}>
                <Button size="lg" className="bg-[#4A154B] hover:bg-[#3d1140] text-lg px-8 py-6">
      ...
      <section className="bg-slate-50 py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900">Why Speak for Me?</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold">Private & Ephemeral</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold">Refine & Customize</h3>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Ready to communicate better?</h2>
