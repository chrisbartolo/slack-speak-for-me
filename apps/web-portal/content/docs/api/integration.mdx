...
|---------|-------------|---------|
| `/speakforme-watch` | Start watching the current conversation for suggestions | Type `/speakforme-watch` in any channel |
| `/speakforme-unwatch` | Stop watching the current conversation | Type `/speakforme-unwatch` in a watched channel |
| `/speakforme-report` | Generate a weekly report on demand | Type `/speakforme-report` in any channel |
| `/speakforme-tasks` | View pending tasks detected from your messages | Type `/speakforme-tasks` in any channel |
