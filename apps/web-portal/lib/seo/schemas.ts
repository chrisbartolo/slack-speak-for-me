    ...
    offers: [
      {
        ...
        price: '9',
        priceCurrency: 'EUR',
        description: 'Handle ~1 difficult message per day, AI style learning, conversation context, unlimited refinements',
        priceSpecification: {
      ...
      },
      {
        ...
        price: '15',
        priceCurrency: 'EUR',
        description: 'Handle 3+ messages per day, person notes, priority support, all Starter features',
        priceSpecification: {
          '@type': 'UnitPriceSpecification',
          price: '15',
          priceCurrency: 'EUR',
      ...
      },
      {
        ...
        price: '12',
        priceCurrency: 'EUR',
        description: 'All Pro features for your team, usage analytics, communication insights dashboard',
        priceSpecification: {
          '@type': 'UnitPriceSpecification',
          price: '12',
          priceCurrency: 'EUR',
      ...
      },
      {
        ...
        price: '18',
        priceCurrency: 'EUR',
        description: 'Advanced analytics, enterprise SSO/SAML, custom API integrations, dedicated account manager',
        priceSpecification: {
          '@type': 'UnitPriceSpecification',
          price: '18',
          priceCurrency: 'EUR',
